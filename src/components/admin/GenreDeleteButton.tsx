...
import { adminDeleteGenre } from "@/server/actions/admin";
...
export function GenreDeleteButton({ id, name }: GenreDeleteButtonProps) {
  ...
  const handleDelete = () => {
    ...
    startTransition(async () => {
      const result: AdminActionResult = await adminDeleteGenre(id);
      if (!result.ok) {
